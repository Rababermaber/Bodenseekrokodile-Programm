...
/*****************SCHUSS*********************/	
	#define TIME_MAX_SCHUSS 10 			//gibt die zeit an in der MAX_SCHUSS schüsse gemacht werden dürfen in sekunden an
	#define MAX_SCHUSS 4 				//gibt die maximale anzahle von schüssen in der zeit TIME_MAX_SCHUSS an